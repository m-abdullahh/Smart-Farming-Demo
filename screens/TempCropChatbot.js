...
const FarmChatbot = () => {
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: "ChatBot",
      content: "Hi! You can talk to me about Crops🌾 and Weather☁️ of Pakistan, Will be Happy to help you!! 😄 ",
  ...
  const handleSend = async (messageText) => {
    ...
    try {
      const response = await fetch(`https://m-abdu11ah-cropapp.hf.space/query?query='${encodeURIComponent(messageText)}'`, {
        method: "GET",
      });
